...
listHistory = em.createQuery("SELECT h FROM  History h ").getResultList();
...
listReader = em.createQuery("SELECT r FROM  Reader r ").getResultList();
...
listBook = em.createQuery("SELECT b FROM  Book b ").getResultList();
